...
/******************************************************************************
* 函数名称: bool_bl service_22_check_len(const uint8_bl* msg_buf, uint16_bl msg_dlc)
...
* 其它说明: 无
******************************************************************************/
bool_bl service_22_check_len(const uint8_bl* msg_buf, uint16_bl msg_dlc)
{
	bool_bl ret = FALSE;
...
/******************************************************************************
* 函数名称: void service_22_ReadDataByIdentifier(const uint8_bl* msg_buf, uint16_bl msg_dlc)
...
* 其它说明: 无
******************************************************************************/
void service_22_ReadDataByIdentifier(const uint8_bl* msg_buf, uint16_bl msg_dlc)
{
    uint8_bl rsp_buf[128];
	uint16_bl did;
