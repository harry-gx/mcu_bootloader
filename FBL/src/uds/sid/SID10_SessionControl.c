...
/******************************************************************************
* 函数名称: bool_bl service_10_check_len(const uint8_bl* msg_buf, uint16_bl msg_dlc)
...
* 其它说明: 无
******************************************************************************/
bool_bl service_10_check_len(const uint8_bl* msg_buf, uint16_bl msg_dlc)
{
	bool_bl ret = FALSE;
...
/******************************************************************************
* 函数名称: void service_10_SessionControl(const uint8_bl* msg_buf, uint16_bl msg_dlc)
* 功能说明: 10 服务 - 诊断会话控制
...
* 其它说明: 无
******************************************************************************/
void service_10_SessionControl(const uint8_bl* msg_buf, uint16_bl msg_dlc)
{
    uint8_bl subfunction = 0;
	uint8_bl rsp_buf[8];
	...
	rsp_buf[2] = (uint8_bl)(P2_SERVER >> 8);
	rsp_buf[3] = (uint8_bl)(P2_SERVER & 0x00ff);
	rsp_buf[4] = (uint8_bl)(P2X_SERVER >> 8);
	rsp_buf[5] = (uint8_bl)(P2X_SERVER & 0x00ff);
