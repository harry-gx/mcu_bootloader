...
/******************************************************************************
* 函数名称: void service_31_RoutineControl(const uint8_bl* msg_buf, uint16_bl msg_dlc)
* 功能说明: 31 服务 - 例程控制
...
/******************************************************************************
* 函数名称: bool_bl service_31_check_len(const uint8_bl* msg_buf, uint16_bl msg_dlc)
