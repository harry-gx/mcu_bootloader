...
/******************************************************************************
* 函数名称: bool_bl service_2E_check_len(const uint8_bl* msg_buf, uint16_bl msg_dlc)
...
* 其它说明: 无
******************************************************************************/
bool_bl service_2E_check_len(const uint8_bl* msg_buf, uint16_bl msg_dlc)
{
	bool_bl ret = FALSE;
...
/******************************************************************************
* 函数名称: void service_2E_WriteDataByIdentifier(const uint8_bl* msg_buf, uint16_bl msg_dlc)
...
* 其它说明: 无
******************************************************************************/
void service_2E_WriteDataByIdentifier(const uint8_bl* msg_buf, uint16_bl msg_dlc)
{
    uint8_bl rsp_buf[8];
	uint16_bl did;
	bool_bl write_ret = 0;
