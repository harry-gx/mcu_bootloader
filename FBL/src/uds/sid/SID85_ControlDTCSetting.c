...
bool_bl  dtc_setting = UDS_DTC_SETTING_ON;

/******************************************************************************
* 函数名称: bool_bl service_85_check_len(const uint8_bl* msg_buf, uint16_bl msg_dlc)
...
* 其它说明: 无
******************************************************************************/
bool_bl service_85_check_len(const uint8_bl* msg_buf, uint16_bl msg_dlc)
{
	bool_bl ret = FALSE;
...
/******************************************************************************
* 函数名称: void service_85_ControlDTCSetting(const uint8_bl* msg_buf, uint16_bl msg_dlc)
...
* 其它说明: 无
******************************************************************************/
void service_85_ControlDTCSetting(const uint8_bl* msg_buf, uint16_bl msg_dlc)
{
